  ...
  return (
    <div className='shadow-xl'> 
      ...
      <div className='p-5'>
        ...
        <h3>dsds</h3>
        <button className='bg-orange-400 hover:bg-orange-500 mt-5 w-full p-3 font-bold text-white text-lg cursor-pointer' onClick={()=>selectRecipe(drink.idDrink)}>Ver receta</button>
      </div>
    </div>
  )
}
