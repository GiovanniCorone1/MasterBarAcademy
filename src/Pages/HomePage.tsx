...
const HomePage = () => {
  ...
  Aprende de expertos de la industria y domina el arte de la creación de cócteles.</p>
          ...
          <button className="bg-secondary hover:bg-secondary/75 transition-colors duration-500 cursor-pointer px-4 py-2 text-xl rounded-2xl text-[#fbf7eb]">Inscríbete</button>
